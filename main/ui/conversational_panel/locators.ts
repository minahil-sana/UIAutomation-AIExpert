...
export const conversationalPanelLocators = {
    ...
    'Table and Chart': {
        ...
        getTableGridEvaContainer: (page: Page): Locator => conversationalPanelLocators.getLatestResponseMessage(page).getByTestId('eva-table'),
        getTableGridRoot: (page: Page): Locator => conversationalPanelLocators['Table and Chart'].getTableGridEvaContainer(page).locator('.ag-root[role="treegrid"]'),
        getTableGridColumnHeaders: (page: Page): Locator => conversationalPanelLocators['Table and Chart'].getTableGridRoot(page).getByRole('columnheader'),
        getTableGridColumnHeaderByName: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridRoot(page).getByRole('columnheader', { name: columnName, exact: true }),
        getTableGridRenderedRows: (page: Page): Locator => conversationalPanelLocators['Table and Chart'].getTableGridRoot(page).locator('.ag-center-cols-container [role="row"][row-index]'),
        getTableGridFiltersButton: (page: Page): Locator => conversationalPanelLocators['Table and Chart'].getTableGridEvaContainer(page).getByRole('tab', { name: 'Filters', exact: true }),
        getTableGridVisibleFiltersPanel: (page: Page): Locator => conversationalPanelLocators['Table and Chart'].getTableGridEvaContainer(page).locator('.ag-tool-panel-wrapper[role="tabpanel"][aria-hidden="false"] .ag-filter-toolpanel'),
        getTableGridFilterGroupHeader: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridVisibleFiltersPanel(page).locator('.ag-filter-toolpanel-group-level-0-header[role="button"]').filter({ hasText: columnName }),
        getTableGridFilterGroupContainer: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridVisibleFiltersPanel(page).locator('.ag-filter-toolpanel-group-wrapper').filter({ hasText: columnName }).locator('.ag-filter-toolpanel-group-container[aria-hidden="false"]'),
        getTableGridFilterInput: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridFilterGroupContainer(page, columnName).locator('.ag-filter-body-wrapper input').first(),
        getTableGridFilterApplyButton: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridFilterGroupContainer(page, columnName).getByRole('button', { name: 'Apply', exact: true }),
        getTableGridFilterResetButton: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridFilterGroupContainer(page, columnName).getByRole('button', { name: 'Reset', exact: true }),
        getTableGridFilterOperatorDropdown: (page: Page, columnName: string): Locator => conversationalPanelLocators['Table and Chart'].getTableGridFilterGroupContainer(page, columnName).locator('.ag-picker-field-wrapper[role="combobox"]').first(),
        getTableGridFilterOperatorOption: (page: Page, optionLabel: string): Locator => page.getByRole('option', { name: optionLabel, exact: true }).first(),
